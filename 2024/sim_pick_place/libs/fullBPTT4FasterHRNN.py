...
class fullBPTTtrainer4FasterHRNN:
    """
    ...
    def process_epoch(self, data, training=True):
        ...
        for n_batch, ((x_imgs, x_states), (y_imgs, y_states)) in enumerate(data):
            ...
            y_imgs_hat, y_states_hat, hids_dict, hid_dict = self.model(x_imgs, x_states, hid_dict)
            ...
            hid_loss = (self.criterion(hids_dict["img_feat"], hids_dict["_img_feat"]) \
                        + self.criterion(hids_dict["state"], hids_dict["_state"]) \
                        + self.criterion(hids_dict["union1"], hids_dict["_union1"])) * 0.1
            
            loss = img_loss + state_loss    #  + hid_loss
