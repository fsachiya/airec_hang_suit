...
try:
    from libs.layer import HierarchicalMambaCell
except:
    from layer import HierarchicalMambaCell


class HSAMamba(nn.Module):
    def __init__(
        self,
        srnn_hid_dim=50,
        urnn_hid_dim=20,
        ...
        self.hmamba = HierarchicalMambaCell(
    ...
    def forward(self, xi, xv, xp, states=None):
        ...
        states = self.hmamba(xk, xv, xp, states) # xf, 
        ...
        return yv, yp, enc_pts, dec_pts, states # yi, 
...
if __name__ == "__main__":
    ...
    # test RNNModel
    model = HSAMamba(rnn_dim=50, union_dim=20, joint_dim=joint_dim)
    summary(
        model,
