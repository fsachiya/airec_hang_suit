...
parser.add_argument("--model", type=str, default="hierarchical_rnn")
...
parser.add_argument("--key_point_loss", type=float, default=1.0)
...
model = HierarchicalRNN(srnn_input_dims={"k": args.key_point_num * 2, 
...
train_loss_list, train_img_loss_list, train_key_point_loss_list, train_joint_loss_list, train_cmd_loss_list = [], [], [], [], []
test_loss_list, test_img_loss_list, test_key_point_loss_list, test_joint_loss_list, test_cmd_loss_list = [], [], [], [], []
...
with tqdm(range(args.epoch)) as pbar_epoch:
    for epoch in pbar_epoch:
        ...
        train_key_point_loss_list.append(train_loss_dir["total_key_point_loss"])
        train_joint_loss_list.append(train_loss_dir["total_joint_loss"])
        train_cmd_loss_list.append(train_loss_dir["total_cmd_loss"])
        
        test_loss_list.append(test_loss_dir["total_loss"])
        test_img_loss_list.append(test_loss_dir["total_img_loss"])
        test_key_point_loss_list.append(test_loss_dir["total_key_point_loss"])
        test_joint_loss_list.append(test_loss_dir["total_joint_loss"])
        test_cmd_loss_list.append(test_loss_dir["total_cmd_loss"])
...
ax[1].plot(range(len(train_img_loss_list)), train_img_loss_list, label="image")
ax[1].plot(range(len(train_key_point_loss_list)), train_key_point_loss_list, label="key_point")
...
ax[2].plot(range(len(test_img_loss_list)), test_img_loss_list, label="image")
ax[2].plot(range(len(test_key_point_loss_list)), test_key_point_loss_list, label="key_point")
