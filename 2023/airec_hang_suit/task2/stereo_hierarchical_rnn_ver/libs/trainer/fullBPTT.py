...
class fullBPTTtrainer:
    ...
    def __init__(self, 
                 ...
                 scaler, 
                 max_norm, 
                 loss_w_dic:dict[str, float]={"i": 0.1, "k": 1.0, "v": 1.0, "c": 1.0}, 
                 device="cpu"):
        self.device = device
    ...
    def process_epoch(self, data, training=True):
        ...
        for n_batch, ((x_left_img, x_right_img, x_joint, x_cmd), 
            ...
            with torch.cuda.amp.autocast(): 
                ...
                stereo_enc_key_point_loss = criterion(left_enc_pts_data, right_enc_pts_data) * self.loss_w_dic["k"]
                stereo_dec_key_point_loss = criterion(left_dec_pts_data, right_dec_pts_data) * self.loss_w_dic["k"]
            ...
            if training:
                ...
                nn.utils.clip_grad_norm_(self.model.parameters(), max_norm=self.max_norm)  # ここで勾配の最大値を指定
