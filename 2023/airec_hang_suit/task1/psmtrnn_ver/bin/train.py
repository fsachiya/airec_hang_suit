...
try:
    from libs.model import CNNPSMTRNN
...
parser.add_argument("--model", type=str, default="psmtrnn")
...
model = CNNPSMTRNN(context_size, tau)
...
save_name = os.path.join(log_dir_path, "PSMTRNN.pth")
