...
class MultimodalDataset(Dataset):
    ...
    def __init__(self, left_img_data, right_img_data, arm_joint_data, hand_state_data, stdev=0.0, training=True):
        """
    ...
    def __getitem__(self, idx):
        ...
        return [[x_left_img, x_right_img, x_joint, x_state], [y_left_img, y_right_img, y_joint, y_state]]
