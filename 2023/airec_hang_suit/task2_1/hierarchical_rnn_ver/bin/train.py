...
# img
_img_data = np.load(f"{data_dir_path}/train/left_img.npy")
...
with tqdm(range(args.epoch)) as pbar_epoch:
    for epoch in pbar_epoch:
        ...
        train_img_loss_list.append(train_loss_dic["total_img_loss"])
        train_key_point_loss_list.append(train_loss_dic["total_key_point_loss"])
        ...
        test_img_loss_list.append(test_loss_dic["total_img_loss"])
        test_key_point_loss_list.append(test_loss_dic["total_key_point_loss"])
