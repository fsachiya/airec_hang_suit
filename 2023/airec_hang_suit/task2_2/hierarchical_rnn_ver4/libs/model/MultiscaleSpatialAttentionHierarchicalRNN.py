...
class MSAHSARNN(nn.Module):
    def __init__(
        ...
        self.img_cbam_encoder = nn.Sequential(
            CBAMEncoder(self.key_dim, self.img_size),   # *self.grid_num    # *self.overlaped_grid_num
        )
    ...
    def forward(self, xi, xv, xp, states=None):
        ...
        enc_pts = _enc_pts  # _enc_pts.flatten(1,2)
        xk = enc_pts
        ...
        return yi, yv, yp, enc_pts, dec_pts, yf, states #, _xf
