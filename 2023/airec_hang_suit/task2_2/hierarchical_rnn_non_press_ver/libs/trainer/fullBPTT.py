...
from utils.util import  tsp_bruteforce
...
class fullBPTTtrainer:
    ...
    def process_epoch(self, data, training=True):
        ...
        total_loss = 0.0
        for n_batch, ((x_img, x_vec), (y_img, y_vec)) in enumerate(data):   # , x_press , y_press
            ...
            T = x_img.shape[1]
            for t in range(T - 1):
                yi_hat, yv_hat, enc_pts, dec_pts, states = self.model(  # , yp_hat
                    x_img[:, t], x_vec[:, t], states    # , x_press[:, t]
                )
            ...
            loss = img_loss + vec_loss + pt_loss   #  + press_loss   + var_loss
