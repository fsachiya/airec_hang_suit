...
class HierarchicalRNNCell(nn.Module):
    ...
    def get_initial_states(self, x):
        ...
        states = [prev_ksrnn_state, prev_vsrnn_state, prev_urnn_state]  # , prev_psrnn_state
        return states
    ...
    def forward(self, 
        ...
        if states is not None:
            ...
            prev_ksrnn_state, prev_vsrnn_state, prev_urnn_state = states    # , prev_psrnn_state
        else:
            # prev_rnn1, prev_rnn2, prev_union = self.get_initial_states(xv)
            prev_ksrnn_state, prev_vsrnn_state, prev_urnn_state = self.get_initial_states(xk)   # , prev_psrnn_state
        ...
        urnn_input = torch.cat((prev_ksrnn_state[0], 
                                prev_vsrnn_state[0]), axis=-1)  # ,prev_psrnn_state[0]
        ...
        prev_ksrnn_hid, prev_vsrnn_hid = torch.split(   # , prev_psrnn_hid
        ...
        states = [new_ksrnn_state, new_vsrnn_state, new_urnn_state] # , new_psrnn_state
