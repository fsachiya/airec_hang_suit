...
class MultimodalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(x_img.shape, "img")
        # print(x_vec.shape, "vec")
        # print(x_press.shape, "press")
        # print(y_img.shape, "img")
        # print(y_vec.shape, "vec")
        # print(y_press.shape, "press")
        
        return [[x_img, x_vec, x_press], [y_img, y_vec, y_press]]
