...
class HierarchicalRNNCellwithoutKey(nn.Module):
    # :: HierachicalRNNCell
    ...
    def __init__(self,
        ...
        super(HierarchicalRNNCellwithoutKey, self).__init__()
