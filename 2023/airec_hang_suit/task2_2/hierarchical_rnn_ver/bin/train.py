...
try:
    ...
    from libs.mode import AttnHSARNN
...
parser.add_argument("--lr", type=float, default=0.0001)   # 1e-3
...
# for i in range(vec_data.shape[2]):
#     plt.figure()
#     plt.plot(vec_data[:,:,i].T)
#     plt.savefig(f"./fig/sample_vec_train_kind{i}.png")
#     plt.close()   
# import ipdb; ipdb.set_trace()
...
# print(arm_joint_data.shape)
# print(hand_cmd_data.shape)
...
_arm_joint_data = normalization(raw_arm_joint_data, arm_joint_bounds, minmax) # _minmax
_arm_joint_data = _arm_joint_data[:,:,7:]
arm_joint_data = np.apply_along_axis(moving_average, 1, _arm_joint_data, size=5)
...
# for i in range(vec_data.shape[0]):
#     plt.figure()
#     plt.plot(vec_data[i,:,3])
#     plt.ylim(0.0, 1.0)
#     plt.savefig(f"./fig/sample_vec_data{i}_3v.png")
#     plt.close()

# for i in range(vec_data.shape[2]):
#     plt.figure()
#     plt.plot(vec_data[:,:,i].T)
#     plt.savefig(f"./fig/sample_vec_kind{i}.png")
#     plt.close()
