...
class StereoHSARNN(nn.Module):
    ...
    def forward(self, xli, xri, xv, states=None):   # , xp
        # Encode input image
        # im_hid
        ...
        states = self.hrnn(xlk, xrk, xv, states) # enc_pts  , xp
        ...
        return [yli, yri, yv, 
                left_enc_pts, left_dec_pts, right_enc_pts, right_dec_pts, states]# rnn_hid  # , yp
