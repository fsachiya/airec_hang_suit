...
class StereoHierarchicalRNNCell(nn.Module):
    ...
    def get_initial_states(self, x):
        ...
        states = [prev_left_ksrnn_state, prev_right_ksrnn_state, 
                  prev_vsrnn_state, prev_urnn_state]    # , prev_psrnn_state
        return states
    ...
    def forward(self, 
        ...
        if states is not None:
            ...
            [prev_left_ksrnn_state, prev_right_ksrnn_state, 
             prev_vsrnn_state, prev_urnn_state] = states    # , prev_psrnn_state
        else:
            # prev_rnn1, prev_rnn2, prev_union = self.get_initial_states(xv)
             [prev_left_ksrnn_state, prev_right_ksrnn_state, 
             prev_vsrnn_state, prev_urnn_state] = self.get_initial_states(xlk)  # , prev_psrnn_state
        ...
        prev_left_ksrnn_hid, prev_right_ksrnn_hid, prev_vsrnn_hid = torch.split(    # , prev_psrnn_hid
        ...
        states = [new_left_ksrnn_state, new_right_ksrnn_state, 
                  new_vsrnn_state, new_urnn_state]  # , new_psrnn_state
