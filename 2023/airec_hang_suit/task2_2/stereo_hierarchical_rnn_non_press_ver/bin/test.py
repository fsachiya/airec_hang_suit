...
yli_hat_list, yri_hat_list, yv_hat_list = [], [], []
...
loss = left_img_loss + right_img_loss + vec_loss + pt_loss + stereo_xy_loss
...
ani.save(f'./output/test_idx_{idx}/{params["tag"]}/StereoHierarchicalRNNnonPress_{params["tag"]}.gif')
