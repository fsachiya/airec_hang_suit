...
parser.add_argument("--state", type=str, choices=["f","k","v","p","u","i", "fc", "kc", "vc", "pc", "uc"], default="u")
...
fsrnn_cell_list, ksrnn_cell_list, vsrnn_cell_list, psrnn_cell_list, urnn_cell_list = [], [], [], [], []
...
for t in range(T-1):
    ...
    [fsrnn_state, ksrnn_state, vsrnn_state, psrnn_state, urnn_state] = states # psrnn_state, 
