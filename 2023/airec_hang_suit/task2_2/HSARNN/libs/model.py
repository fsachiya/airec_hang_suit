...
from HierachicalRNNCell import HierachicalRNNCell
...
class HSARNN(nn.Module):
    def __init__(
        ...
        self.rec = HierachicalRNNCell(input_dim1=joint_dim, input_dim2=key_dim, rnn_dim=rnn_dim, union_dim=union_dim)
