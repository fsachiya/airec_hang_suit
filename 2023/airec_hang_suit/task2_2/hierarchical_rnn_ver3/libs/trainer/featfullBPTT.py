...
class featfullBPTTtrainer:
    ...
    def process_epoch(self, data, step, training=True): # with step
        ...
        for n_batch, ((x_img, x_vec, x_press), (y_img, y_vec, y_press)) in enumerate(data):   # x_joint, y_joint
            ...
            modality_loss = img_loss + roll_pt_loss + vec_loss + press_loss + delta_pt_loss
            # print("modality",
            #       img_loss.item(), 
            #       roll_pt_loss.item(),
            #       vec_loss.item(), 
            ...
            state_var_loss = vsrnn_state_var_loss + urnn_state_var_loss   #  + ksrnn_state_var_loss fsrnn_state_var_loss +  + psrnn_state_var_loss
            # print("state", 
            ...
            state_var_loss_w = 10 ** (modality_order - state_var_order - 1)
            ...
            pt_var_loss_w = 10 ** (modality_order - pt_var_order - 1)
            pt_var_loss *= pt_var_loss_w
            
            
            seq_pt_var_loss_w = 1e-7
            ...
            seq_pt_var_loss_w = 10 ** (modality_order - seq_pt_var_order - 1)
            ...
            seq_state_var_loss = vsrnn_seq_state_var_loss + psrnn_seq_state_var_loss + urnn_seq_state_var_loss  # ksrnn_seq_state_var_loss + fsrnn_seq_state_var_loss + 
            # print("seq_state", 
            ...
            seq_state_var_loss_w = 10 ** (modality_order - seq_state_var_order - 1)
            ...
            loss = modality_loss + state_var_loss + cell_var_loss + pt_var_loss + seq_pt_var_loss + seq_state_var_loss
