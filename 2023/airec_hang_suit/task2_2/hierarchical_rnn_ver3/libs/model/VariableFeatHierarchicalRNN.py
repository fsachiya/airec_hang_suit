...
try:
    from libs.layer import VariableFeatHierarchicalRNNCell
except:
    from layer import VariableFeatHierarchicalRNNCell


class VFHSARNN(nn.Module):
    def __init__(
        self,
        # rnn_dim,
        # union_dim,
        ...
        self.vhrnn = VariableFeatHierarchicalRNNCell(
    ...
    def forward(self, xi, xv, xp, step, states=None):
        ...
        states = self.vhrnn(xf, xk, xv, xp, step, states) # enc_pts
