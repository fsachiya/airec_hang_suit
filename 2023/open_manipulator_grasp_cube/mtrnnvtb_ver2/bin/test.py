...
for loop_ct in range(nloop):
    ...
    # predict rnn
    y_image, y_joint, state, variable_fast_tau = model(x_img, x_joint, prev_fast_tau, state)
    ...
    variable_fast_tau_list.append(tensor2numpy(variable_fast_tau[0]))
    prev_fast_tau = variable_fast_tau
